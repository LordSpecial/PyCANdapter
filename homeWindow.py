...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.connectionStatus.setGeometry(QRect(800, 11, 461, 20))
        font = QFont()
        font.setPointSize(12)
        self.connectionStatus.setFont(font)
        self.connectionStatus.setLayoutDirection(Qt.RightToLeft)
        self.connectionStatus.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.connectionStatus.setText(QCoreApplication.translate("MainWindow", u"CANdaptor NOT CONNECTED", None))
    # retranslateUi
